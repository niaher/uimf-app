...
function SvelteComponent$11(options) {
	...
	if (!document.getElementById("svelte-1713469982-style")) add_css$2();
...
function create_each_block_2(state, data, row, row_index, columnsOrdered_1, column_1, column_index, component) {
	...
	var formoutput = new SvelteComponent$11({
...
function SvelteComponent$10(options) {
	...
	if (!document.getElementById("svelte-902727033-style")) add_css$1();
...
function SvelteComponent$13(options) {
	...
	if (!document.getElementById("svelte-3113705699-style")) add_css$3();
...
function SvelteComponent$15(options) {
	...
	if (!document.getElementById("svelte-902727033-style")) add_css$5();
...
function SvelteComponent$14(options) {
	...
	if (!document.getElementById("svelte-770985968-style")) add_css$4();
...
assign(SvelteComponent$14.prototype, methods, proto);
...
function oncreate$5() {
    ...
    var input = app.controlRegister.getInput(field.metadata.type).component;
...
function encapsulateStyles$8(node) {
	setAttribute(node, "svelte-96250704", "");
}

function add_css$8() {
	var style = createElement("style");
	style.id = 'svelte-96250704-style';
	style.textContent = "[svelte-96250704].inline,[svelte-96250704] .inline{display:inline-block\r\n    }";
	appendNode(style, document.head);
}
...
function SvelteComponent$18(options) {
	...
	if (!document.getElementById("svelte-96250704-style")) add_css$8();
...
function encapsulateStyles$7(node) {
	setAttribute(node, "svelte-3929654538", "");
}

function add_css$7() {
	var style = createElement("style");
	style.id = 'svelte-3929654538-style';
	style.textContent = "[svelte-3929654538].response,[svelte-3929654538] .response{margin-top:50px}[svelte-3929654538].inline-form .response,[svelte-3929654538] .inline-form .response{margin-top:0;padding:10px 15px}[svelte-3929654538].inline-form h2,[svelte-3929654538] .inline-form h2{margin:0;background:#eee;padding:10px 15px 15px;font-size:15px}";
	appendNode(style, document.head);
}
...
function create_each_block$6(state, visibleInputFields, inputField, inputField_index, component) {
	...
	var forminput = new SvelteComponent$18({
		_root: component._root,
		data: {
			field: inputField,
			app: state.app,
...
function SvelteComponent$17(options) {
	...
	if (!document.getElementById("svelte-3929654538-style")) add_css$7();
...
assign(SvelteComponent$17.prototype, methods$2, proto);
...
function create_main_fragment$16(state, component) {
	...
	return {
		...
		h: function hydrate() {
			encapsulateStyles$6(ul);
			ul.className = "actionlist";
			encapsulateStyles$6(input);
...
function SvelteComponent$16(options) {
	...
	if (!document.getElementById("svelte-3868149080-style")) add_css$6();
...
function encapsulateStyles$9(node) {
	setAttribute(node, "svelte-2449755491", "");
}

function add_css$9() {
	var style = createElement("style");
	style.id = 'svelte-2449755491-style';
	style.textContent = "[svelte-2449755491].inline-form,[svelte-2449755491] .inline-form{border-width:1px 1px 1px;border-style:solid;border-color:#ccc;margin:30px 0;padding:1px 1px;border-radius:5px}";
	appendNode(style, document.head);
}
...
function SvelteComponent$19(options) {
	...
	if (!document.getElementById("svelte-2449755491-style")) add_css$9();
...
controlRegister.registerOutputFieldControl("text", SvelteComponent$7);
controlRegister.registerOutputFieldControl("number", SvelteComponent$8);
controlRegister.registerOutputFieldControl("datetime", SvelteComponent$9);
controlRegister.registerOutputFieldControl("table", SvelteComponent$10, { block: true });
controlRegister.registerOutputFieldControl("formlink", SvelteComponent$12);
controlRegister.registerOutputFieldControl("tabstrip", SvelteComponent$13, { alwaysHideLabel: true, block: true });
controlRegister.registerOutputFieldControl("paginated-data", SvelteComponent$14, { block: true });
controlRegister.registerOutputFieldControl("action-list", SvelteComponent$16, { alwaysHideLabel: true, block: true });
controlRegister.registerOutputFieldControl("inline-form", SvelteComponent$19, { alwaysHideLabel: true, block: true });
controlRegister.registerOutputFieldControl("text-value", SvelteComponent$20);
...
function create_each_block$8(state, items, submenu, submenu_index, component) {
	...
	var sveltecomponent = new SvelteComponent$22({
		_root: component._root,
		data: { menu: submenu }
	});
...
function create_each_block$7(state, menus, menu, menu_index, component) {
	...
	var menuitem = new SvelteComponent$22({
		_root: component._root,
		data: { menu: menu }
	});
...
var server = new UmfServer("http://localhost:58335/api/form/metadata", "http://localhost:58335/api/form/run");
